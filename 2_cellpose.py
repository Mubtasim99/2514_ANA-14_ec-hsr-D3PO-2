...
masks, flows, styles = apply_cellpose(
        mask_channel[:4], image_type='sam', diameter=120, flow_threshold=0.0, cellprob_threshold=0)
visualise_cell_pose(mask_channel[:3], masks, flows)
...
masks, flows, styles = apply_cellpose(
        mask_channel, image_type='sam', diameter=120, flow_threshold=0.0, cellprob_threshold=0)
...
nuc_masks, flows, styles = apply_cellpose(
        nuclear_channel[:4], image_type='sam', diameter=100, flow_threshold=0.4, cellprob_threshold=0)
